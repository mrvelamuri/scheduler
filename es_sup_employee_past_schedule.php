...
print_header($es_lang["past_schedules"]." - ".$employee["u_name"]);
print '<br><br><span class="pagetitle">'.$es_lang["past_schedules"]." - ".$employee["u_name"].'</span><br><img src="images/bar_1.gif" width="75%" height="2">';
...
<td>
	<table>
	<tr><td align="right"><?php print $es_lang["min_left"];?></td><td> <?php print $employee["u_min"];?></td></tr>
	<tr><td align="right"><?php print $es_lang["max_left"];?></td><td> <?php print $employee["u_max"];?></td></tr>
	<tr><td align="right"><b><?php print $es_lang["total_hours"];?></b></td><td><?php print $total_hours;?></td></tr>
	<tr><td align="right"><b><?php print $es_lang["hours_desired"];?></b></td><td><?php print $employee["u_hours"];?></td></tr>
